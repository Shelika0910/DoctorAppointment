                ...
                <div class="table-container">
                    <table class="data-table">
                        ...
                        <tbody>
                            <tr>
                                <td>Raj PV</td>
                                <td><a href="#" class="appointment-link">1</a></td>
                                <td>2</td>
                                <td>2023-10-28 @10:00</td>
                                <td>2023-10-18</td>
                                <td><button class="cancel-btn"><i class="fas fa-times"></i> Cancel</button></td>
                            </tr>
                            <tr>
                                <td>Madhu Mathi</td>
                                <td><a href="#" class="appointment-link">2</a></td>
                                <td>2</td>
                                <td>2023-10-28 @10:00</td>
                                <td>2023-10-18</td>
                                <td><button class="cancel-btn"><i class="fas fa-times"></i> Cancel</button></td>
                            ...
                            <tr>
                                <td>Anjana P</td>
                                <td><a href="#" class="appointment-link">3</a></td>
                                <td>2</td>
                                <td>2023-10-28 @10:00</td>
                                <td>2023-10-23</td>
                                <td><button class="cancel-btn"><i class="fas fa-times"></i> Cancel</button></td>
                            ...
                            <tr>
                                <td>Aswin S</td>
                                <td><a href="#" class="appointment-link">4</a></td>
                                <td>2</td>
                                <td>2023-10-28 @10:00</td>
                                <td>2023-10-23</td>
                                <td><button class="cancel-btn"><i class="fas fa-times"></i> Cancel</button></td>
